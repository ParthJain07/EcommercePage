...
public class IndexPage extends BaseClass {
	...
	public LoginPage clickOnSignIn() {
		action.waitForElement(100, AccountAndList);
	...
	public void search()
	{
		action.waitForElement(200, SearchInput);
		action.type(SearchInput, prop.getProperty("search"));
		action.waitForElement(100, SearchButton);
		action.click(SearchButton);
	}

	public SearchResultPage selectProduct()
	{
		action.waitForElement(100, SelectedProductSpanPrice);
